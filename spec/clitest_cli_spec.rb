...
RSpec.describe "command-line", type: :aruba do
  ...
  context "create instance of class" do
    context "Cmdline nil nil" do
      let(:cmdline) {Clitest::Cmdline.new(nil, nil, test_root_dir, [test_cmd_1, test_cmd_2])}
    ...
    context "Cmdline bin_dir nil" do
      let(:cmdline) {Clitest::Cmdline.new(bin_dir, nil, test_root_dir, [test_cmd_1, test_cmd_2])}
